...
### Ecosystem
- [KnowMint](https://knowmint.shop) - Open-source knowledge marketplace with x402 payment gate on Solana, supporting Web UI, CLI, and MCP server for AI agent autonomous purchases.

...
### Ecosystem
- [pellet.fi](https://pelletfi.com) - x402-native token intelligence on Base. Free market data, safety flags, and search for any Base token. Contract forensics ($0.02 USDC) and full AI analysis with creator wallet history ($0.05 USDC) paid via x402. [MCP server](https://www.npmjs.com/package/@pelletfi/mcp) for AI assistants (`npx -y @pelletfi/mcp`), [CLI](https://www.npmjs.com/package/pelletfi) (`npx pelletfi <token>`), and [.well-known/x402](https://pelletfi.com/.well-known/x402) auto-discovery. Live on Base mainnet, listed on [x402scan](https://www.x402scan.com/server/a5d704ec-9b46-4b1e-8f19-cd47de71bf06).

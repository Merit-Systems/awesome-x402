...
- [Cloudflare Agents x402 Example](https://github.com/cloudflare/agents/tree/main/examples/x402) – Example Cloudflare Agents integration showing x402 payments for agent-accessible services.

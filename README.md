...
### Ecosystem
- [APIMesh](https://apimesh.xyz) - 14 x402-payable web analysis APIs for AI agents. SEO audit, security headers, Core Web Vitals, email verify, tech stack detection, domain availability, email security, and more. 16-tool MCP server: `npx @mbeato/apimesh-mcp-server`.

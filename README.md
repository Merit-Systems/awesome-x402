...
- [x402-refunds](https://github.com/PraneshASP/x402-refunds-poc) -  An autonomous refund mechanism for x402 payments using EIP-712 signed refund authorizations and bonded escrow.

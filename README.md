...
- [DeepBlue API](https://api.deepbluebase.xyz) - Real-time crypto market data and trading signals via x402 micropayments on Base. 8 endpoints: signals, performance, trending, prices, token analysis, wallet tracking, Polymarket odds, and sentiment. $0.001–$0.01 USDC. ([OpenAPI](https://api.deepbluebase.xyz/.well-known/openapi.json))
...
- [DeepBlue API](https://api.deepbluebase.xyz) - Real-time crypto market data, trading signals, and sentiment analysis via x402 micropayments. Endpoints from $0.001 USDC on Base.

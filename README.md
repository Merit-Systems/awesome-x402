...
- [TensorFeed (AI Ecosystem Data API + MCP)](https://tensorfeed.ai) - Real-time AI news, model pricing, service status, MCP registry, GitHub trending, AI papers. Free tier plus 14 premium pay-per-call endpoints in USDC on Base. AFTA-certified ([repo](https://github.com/RipperMercs/tensorfeed)).

...
- [SENTINEL](https://mru-oracle.com) - AML/CFT compliance intelligence API with 77K+ sanctions entities, 159-country jurisdiction risk scoring, compound intelligence, and Mauritius economic data oracle. $0.001–$0.015 USDC on Base. ([GitHub](https://github.com/INJprotocol/mauritius-oracle-))

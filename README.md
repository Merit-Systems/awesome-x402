...
### Example Apps
- [Memory Nexus – Persistent Semantic Memory API for AI Agents](https://memory-nexus.org) – Store, recall, and connect knowledge across sessions. x402-native subscriptions (USDC on Base).

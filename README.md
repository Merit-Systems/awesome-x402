...
- [Web3 Signals – AgentMarketSignal (Crypto Signal Intelligence)](https://github.com/manavaga/web3-signals-mcp) – AI-powered crypto signal API for 20 assets with x402 micropayments ($0.001 USDC on Base). 6 scoring dimensions, market regime detection, MCP tools + REST API.

...
- [x402 Bazaar](https://x402bazaar.org) - Decentralized API marketplace with 69 native x402-powered endpoints, multi-chain USDC payments (Base + SKALE), MCP server, LangChain integration, and `npx x402-bazaar init` one-line setup.

...
- [cipher-scan-api](https://cipher-scan-api.vercel.app) – Solana wallet scanner: SOL balance, SPL tokens, stake accounts, hygiene flags. $0.01 USDC on Base per call.
- [cipher-pwned](https://cipher-pwned.vercel.app) – k-anonymity password-breach lookup (HaveIBeenPwned range). $0.005 USDC on Base per call.
- [cipher-jito-tip](https://cipher-jito-tip.vercel.app) – Jito bundle-tip break-even calculator for Solana MEV-protected trades. $0.01 USDC on Base per call.
- [cipher-repo-health](https://cipher-repo-health.vercel.app) – GitHub repo health report: stars, forks, stale-issue ratio, release cadence, composite score. $0.02 USDC on Base per call.
- [cipher-fred](https://cipher-fred.vercel.app) – FRED (Federal Reserve) macro indicator lookup: latest value, 12-month change, trend. $0.005 USDC on Base per call.

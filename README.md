...
### Ecosystem
- [Orbis API Marketplace](https://orbisapi.com) - x402-native API marketplace with 1,000+ APIs at $0.01/call via USDC on Base. Built for AI agents — covers weather, financial data, text processing, and more. No API keys required.

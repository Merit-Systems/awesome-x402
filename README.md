...
- [Obol – AI Code Generation API](https://obol.sh) — 7 x402-gated endpoints ($5 USDC/call on Base). Describe what you want; Obol generates production code and opens a GitHub PR. No subscription, no copy-paste.

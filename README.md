...
- [x402 Boilerplate – Conflux eSpace](https://github.com/confluxarena/x402-boilerplate) – Production-ready x402 paid AI API (PHP + Node.js facilitator + CLI agent) with EIP-3009 USDT0 settlement on Conflux eSpace. Docker, 87 tests, multi-wallet demo.

...
- [IBANforge](https://github.com/cammac-creator/ibanforge) - IBAN validation and BIC/SWIFT lookup REST API + MCP server with x402 micropayments. $0.003–$0.005/request in USDC on Base. 75+ countries, 121K+ GLEIF BIC entries.

...
- [Blocksize Real-Time Market Data](https://mcp.blocksize.info) - x402-paid real-time crypto, FX, and metals market data API with remote MCP discovery and USDC settlement on Solana and Base.

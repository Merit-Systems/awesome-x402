...
- [OpSpawn Bazaar](https://a2a.opspawn.com) — Seven AI-powered x402 microservices (screenshot, sentiment, summarization, translation, fact-checking, keywords, entities) with USDC micropayments on Base.

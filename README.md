...
- [Kerdos Market Intelligence](https://nonvisceral-eloisa-mousily.ngrok-free.dev) - AI market intelligence API with x402 micropayments on Base. Live crypto sentiment, BTC/ETH regime direction, funding rates, gold/oil signals, whale alerts, and liquidation data across 8 endpoints ($0.01-$0.05 USDC).

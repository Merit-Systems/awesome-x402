...
- [ToolOracle](https://tooloracle.io) - x402 entitlement gateway with 10 intelligence MCP servers and 90+ tools (SEO, e-commerce, memecoin, DeFi, flights, hotels, news, jobs, macro). USDC micropayments on Base, $0.02–$0.15/call. [Discovery](https://tooloracle.io/.well-known/x402)

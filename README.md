...
- [Demaciains AI Agent API](https://github.com/DrGalio/demaciains-api) – 19 AI business intelligence tools (SEO audit, lead scoring, company enrichment, etc.) pay-per-use via x402 on Base. Live at [xpay-server.vercel.app](https://xpay-server.vercel.app). Also available as MCP server.

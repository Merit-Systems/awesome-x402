...
- [Know Your Human (Convrgent)](https://convrgent.ai/kyh) — Personality intelligence API for AI agents. 36 endpoints, 11 personality frameworks, deterministic heuristic engines. $0.10–$25 USDC on Base & Solana. [x402 Discovery](https://convrgent.ai/.well-known/x402)
